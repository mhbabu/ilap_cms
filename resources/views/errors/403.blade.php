...
<div class="ilap-flex items-center justify-center ilap-min-h-screen">
    <div class="ilap-card ilap-p-10 ilap-text-center" style="max-width:440px">
        ...
        <h1 class="ilap-text-3xl ilap-font-extrabold text-rose-600 mt-4">403 — Access Denied</h1>
        <p class="ilap-text-slate-500 ilap-mt-2 ilap-text-sm">You do not have permission to access this page.</p>
