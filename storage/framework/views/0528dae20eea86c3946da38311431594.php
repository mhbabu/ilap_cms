    ...
    <div class="login-wrapper">
        <div class="login-brand">
            ...
            <div class="mt-auto pt-5" style="font-size: 0.75rem; opacity: 0.6;">
                &copy; <?php echo e(date('Y')); ?> iLAP CMS. All rights reserved.
            </div>
        </div>
            ...
            <div class="login-form-card">
                ...
                <?php if($errors->any()): ?>
                    <div class="alert-danger-custom mb-4 d-flex align-items-center gap-2">
                        ...
                        <span class="small fw-medium"><?php echo e($errors->first('email')); ?></span>
                    </div>
                <?php endif; ?>
...
<?php /**PATH /var/www/html/Projects/l/resources/views/auth/login.blade.php ENDPATH**/ ?>